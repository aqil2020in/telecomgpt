...
with st.sidebar:
    ...
    st.info("Use the sidebar pages for domain drill-down: Handover, RLF, Call Drops, RACH, Throughput, Beamforming, RCA Report.")
...
st.caption("Data source: `/workspace/datasets` — pm_counters, handover_events, rlf_events, rach_events, call_drop_events, throughput_metrics")
